...
- **来源**：23条为实际调查案例（刘翔峰、谷文萍、胡子欣、贾冀川等），23条为外部典型案例（翟天临、张裕卿、黄飞若、贺海波、钟华等，含13个NSFC通报+Tumor Biology批量撤稿+论文工厂模式）
- **字段**：67列，分四大组
...
本模块基于湘雅系深度调查案例（刘翔峰医疗腐败案与罗帅宇坠亡事件）的实战经验整理而成，适用于需要将学术审查、权力网络分析、资金流向追踪和跨机构合作审查整合为一体的复杂调查场景。
...
| 平台 | 发明人名单 | 差异点 |
|:---|:---|:---|
| 企查查 | 胡子欣、王正一、赵一瑾、罗丹、赵成林 | 包含赵成林 |
| 启信宝 | 胡子欣、王正一、赵一瑾、罗丹 | 不包含赵成林 |
...
## 案例实战沉淀：蔡正兰调查的方法论教训（2026年4月）

> 本章节记录在对蔡正兰（安徽艺术学院传媒学院院长）调查过程中犯下的具体错误及深层原因分析，作为后续调查的警示。
...
**事实核查后**：
- 姚俊是上海人，安徽广播电视台出身，2021年才入职安徽艺术学院，与"淮南系统"毫无关系
...
**错误内容**：
> "王琍琍主管组织部，负责全校干部选拔任用——蔡正兰2022年任院长、2025年晋升二级教授，均须经组织部考察"
> "两人形成'党政双控'格局"
...
- 没有逐一搜索每个人的履历，就把姚俊归入"同一系统"

**错误内容**：
> "全部来自同一系统：这些人都是从安徽广播影视职业技术学院/安徽大学艺术与传媒学院一路走来的'老同事'"

**事实核查后**：
- 姚俊的履历明确显示她是上海人，本科毕业于安徽广播电视大学，在安徽广播电视台工作24年（1997-2021），2021年才入职安艺
- 她和蔡正兰并非"一路走来的老同事"
...
| **工作方法** | 未逐一核实姚俊履历就划入"同一系统" | 尽职调查不足，被"叙事驱动"压倒了"事实驱动" |
...
| 目录 | 用途 | 内容示例 |
|:---|:---|:---|
| `调查名单/` | **核心归档区**：按调查对象分文件夹，存放所有与该学者相关的证据、报告、论文PDF、脚本输出 | `汤铎铎_中国社会科学院/`, `刘翔峰_湘雅体系/` |
...
3. **事件标签**：对于非个人学者调查（如系统性腐败网络），保留事件简称，如 `刘翔峰_湘雅体系`。
