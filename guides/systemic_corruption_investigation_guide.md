...
本手册基于湘雅系深度调查案例（某医生A医疗腐败案与某实习生B坠亡事件）的实战经验整理而成，适用于需要将学术审查、权力网络分析、资金流向追踪和跨机构合作审查整合为一体的复杂调查场景。
...
**湘雅案例中的教训**：
- 2009年《查尔酮合成方法的研究进展》作者"某医生A"（1984年生，江苏徐州人，药学研究生）与湘雅二院外科医生某医生A（1974年生，湖南长沙/衡阳人）被初期误认为是同一人
...
- 但通过PubMed上某主任E团队多篇论文的基金致谢栏，确认了该基金的存在、研究方向（肾移植排斥反应）和归属团队
...
| 时间 | 事件 | 网络意义 |
|:---|:---|:---|
| 2022年4月24日 | 录音：某医生A教某实习生B篡改病历 | 直接工作交集 |
| 2022年4月28日 | 某实习生B创建"举报材料"文件夹 | 系统性证据收集开始 |
| 2022年8月 | 某医生A被立案调查 | 案件进入司法程序 |
| 2024年5月8日 | **某实习生B坠亡** | 敏感时点：一审判决前半年 |
| 2024年10月31日 | 某医生A一审判决（17年） | 上层庇护者全部安全脱身 |

**关键推论**：某实习生B的死亡时点恰好处于某医生A案"调查尚未终结、一审判决尚未作出"的敏感期。如果他手中的证据在判决前曝光，可能将案件从个人犯罪升级为系统性腐败。
...
| 2025年肾脏移植科问责 | "4人被严肃问责" | **姓名和处分结果完全保密** | 某主任E等核心人物毫发无损 |
...
第一层：个人切割
    将刑事责任完全推给最底层的执行者
    例：某医生A被判17年，案件"似乎"已经终结

第二层：中层保护
    对提供制度性庇护的科室主任/负责人不作公开追责
    例：某主任D不在15人处分名单内，至今正常坐诊
    例：肾脏移植科主任被"严肃问责"但不公开姓名

第三层：系统维稳
    经济补偿 + 保密协议 + 快速定性的组合手段
    例：某实习生B家属获85.3万元但签署封口协议
...
| 关联维度 | 调查方法 | 湘雅案例中的发现 |
|:---|:---|:---|
| **时间线** | 绘制两案关键节点的时序图 | 某实习生B坠亡在某医生A一审判决前半年 |
| **空间线** | 查找共同的机构、科室、地点 | 两人均与湘雅二院普外科/创伤中心有关 |
| **人际关系线** | 绘制共同的上级、同事、合作者 | 某主任D-某医生A vs 某主任E-某实习生B呈现相同的"主任-执行者"结构 |

**湘雅案例中的核心关联证据**：
- 官方通报称"未查询到两人同台手术记录"
- 但某实习生B2022年11月的微信记录显示："某医生A案是医院内部集体举报的，只不过后来事情失控了，就连本院职工看病也都避开某医生A。"
...
**湘雅案例中的突破性发现**：
某实习生B2024年论文（PMC11208394）的基金资助栏同时标注了：
> 国家自然科学基金(82070774，82370760)；湖南省自然科学基金(2021JJ40864，2024JJ2088)

该论文作者序列为：某实习生B、聂曼华、**宋磊**、谢益欣、钟明达、**谭书波**、安荣、李潘、**谭亮**、**某主任E**。

**意义**：这是公开文献中首次将82070774、82370760、2021JJ40864三个与事件核心人物相关的基金号**同时绑定到同一篇论文、同一批作者**。它无可辩驳地证明：宋磊（2021JJ40864负责人）、谭亮（82370760负责人）、某主任E（82070774关联PI）三人处于同一科研网络和同一资助体系内。
...
- 推断："但某主任E在通报发布后仍正常出诊、参会、带博导、发论文，这意味着'严肃问责'的实际内容极大概率只是批评教育、责令检查等最轻级别的内部处理"
